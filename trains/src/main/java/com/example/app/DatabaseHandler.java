...
public class DatabaseHandler extends Config {
    ...
    public void signUpTrain(Train train) throws SQLException, ClassNotFoundException {// Этот метод добавляет нового пользователя в базу данных
    ...
    public Train getTrains(TextArea show_Tr){// Этот метод получает информацию о пользователе из базы данных
    ...
    public void signUpRais(Rais rais) throws SQLException, ClassNotFoundException {// Этот метод добавляет нового пользователя в базу данных
    ...
    public Train getRais(TextArea futR){// Этот метод получает информацию о пользователе из базы данных
